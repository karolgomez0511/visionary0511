...
if (empty($_REQUEST['id'])) {
    ...
    $query_producto = mysqli_query($conexion, "SELECT codproducto, descripcion, proveedor, precio,precio_real, existencia FROM producto WHERE codproducto = $id_producto");
...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['cantidad']) || !empty($_POST['precio']) || !empty($_POST['producto_id'])) {
        ...
        $query_insert = mysqli_query($conexion, "INSERT INTO entradas(codproducto,cantidad,precio,precio_real,usuario_id) VALUES ($producto_id, $cantidad, $precio,$precioreal, $usuario_id)");
        if ($query_insert) {
            // ejecutar procedimiento almacenado
            $query_upd = mysqli_query($conexion, "CALL actualizar_precio_producto($cantidad,$precio,$precioreal,$producto_id)");
