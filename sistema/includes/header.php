			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item">
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseProveedor" aria-expanded="true" aria-controls="collapseUtilities">
						...
						<span>Marca de Armazones</span>
						<i class="fas fa-angle-down fa-lg float-right"></i>
					</a>
					<div id="collapseProveedor" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-primary py-2 collapse-inner rounded">
							<a class="collapse-item" href="registro_proveedor.php">Nueva Marca</a>
							<a class="collapse-item" href="lista_proveedor.php">Marcas</a>
						</div>
					</div>
				</li>
				<li class="nav-item">
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSucursales" aria-expanded="true" aria-controls="collapseUtilities">
						<i class="fas fa-hospital"></i>
						<span>Sucursales</span>
						<i class="fas fa-angle-down fa-lg float-right"></i>
					</a>
					<div id="collapseSucursales" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-primary py-2 collapse-inner rounded">
							<a class="collapse-item" href="registro_sucursal.php">Nueva Sucursal</a>
							<a class="collapse-item" href="lista_sucursal.php">Sucursales</a>
						</div>
					</div>
				</li>
				<?php if ($_SESSION['rol'] == 1) { ?>
					...
					<li class="nav-item">
						<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseExpedientes" aria-expanded="true" aria-controls="collapseUtilities">
							<i class="fas fa-folder"></i>
							<span>Expedientes</span>
							<i class="fas fa-angle-down fa-lg float-right"></i>
						</a>
						<div id="collapseExpedientes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
							<div class="bg-primary py-2 collapse-inner rounded">
								<a class="collapse-item" href="registro_expediente.php">Nuevo Expediente</a>
								<a class="collapse-item" href="lista_expedientes.php">Expedientes</a>
								<a class="collapse-item" href="registro_expediente.php">Nueva Orden</a>
								<a class="collapse-item" href="registro_expediente.php">Ordenes</a>
							</div>
						</div>
					</li>
